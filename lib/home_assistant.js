    ...
    this.publishAutoDiscoveryTopics = function(UNIT_PARAMETERS, SYSTEM_SETTINGS) {
        ...
        zones.forEach(function(z) {
            ...
            [1, 2, 3].forEach(function(notchNum) {
                ...
                mqtt.publish(this.discovery_prefix + '/number/bkc-mqtt-dip-' + z.id + '/notch/' + notchNum + '/gain/config',
                ...
                mqtt.publish(this.discovery_prefix + '/sensor/bkc-mqtt-dip-' + z.id + '/notch/' + notchNum + '/frequency/config',
                ...
                mqtt.publish(this.discovery_prefix + '/number/bkc-mqtt-dip-' + z.id + '/notch/' + notchNum + '/width/config',
            ...
            var fm_mode_config = {
                name: 'FM Mode',
                unique_id: 'bkc-mqtt-dip-' + z.id + '_fm_mode',
