...
/**
 * Source input list (Appendix A Note 3). id is the SOURCE_INPUT parameter id
 * (00h=FM, 01h=AM, 02h=Dedicated, 03h..0Bh=Input 1..9); title is the default
 * label used when the unit has not stored a custom Input Title in Appendix B.
 */
SystemSettings.SOURCE_INPUTS = [
	{ id: '00', title: 'FM' },
	{ id: '01', title: 'AM' },
