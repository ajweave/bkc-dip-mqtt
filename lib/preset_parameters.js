...
PresetParameters.prototype.getInput = function() {
	...
	if (this.systemSettings && inputId) {
		...
		var input = inputs.find(function(i) { return i.id === inputId; });
...
PresetParameters.prototype.setInput = function(input) {
	var inputId = input;
	if (this.systemSettings && input) {
		var inputs = this.systemSettings.getInputs();
		var found = inputs.find(function(i) { return i.title === input; });
		if (found) inputId = found.id;
	}
