...
var PresetParameters = module.exports = function(receiveId, zoneId, driver) {
...
PresetParameters.prototype.setPowerState = function(state) {
	...
	driver.send(this.receiveId, 'S,Z' + this.zoneId + ',24=' + v);
	driver.send(this.receiveId, 'G,Z' + this.zoneId + ',24=' + v);
};

PresetParameters.prototype.setPresetParameter = function(parameter, value) {
	console.log("Sending parameter", parameter);
	driver.send(this.receiveId, 'S,P' + this.zoneId + '=FF,' + parameter + '=' + value);
};
...
PresetParameters.prototype.setVolumeDb = function(db) {
	...
	driver.send(this.receiveId, 'S,P' + this.zoneId + '=FF,' + PresetParameters.VOLUME + '=' + v);
};
...
PresetParameters.prototype.setInput = function(input) {
	driver.send(this.receiveId, 'S,P' + this.zoneId + '=FF,' + PresetParameters.SOURCE_INPUT + '=' + input);
};
